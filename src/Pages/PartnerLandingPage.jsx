        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
            <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
                ...
                <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]">
                    Your ultimate social hub for gossip enthusiasts! Discover intriguing features,
                    connect with like-minded individuals, and find your perfect gossip partner.
                    Dive into a vibrant community experience and explore the art of conversation like never before
                </p>
            </header>
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500 ">
            ...
            <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
                ...
                <div className="my-24 flex lg:w-[50%] flex-col gap-10 ">
                    ...
                    <p className="text-base font-medium text-richblack-500 lg:w-[95%]">
                ...
                <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                    ...
                    <p className="text-base font-medium text-richblack-500 lg:w-[95%]">
                        Our mission goes beyond just delivering courses online.
                         ...
                         from one another. We believe that knowledge thrives 
                         in an environment of sharing and dialogue, and we foster 
